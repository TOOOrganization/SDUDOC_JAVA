...
@Service(value = "Ds2AuthorityManagementService")
public class Ds2AuthorityManagementServiceImpl implements Ds2AuthorityManagementService {

    @Qualifier("ds2EntityManager")
    @Autowired
